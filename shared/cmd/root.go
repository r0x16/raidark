...
var RootCmd = &cobra.Command{
	Use:   "raidark",
	Short: "Run the Raidark API and maintenance commands.",
	Long:  "Raidark exposes commands for starting the HTTP API, running schema migrations, and loading seed data.",
}
